...
import { FaFacebook, FaGithub, FaLinkedin, FaTwitch, FaTwitter } from 'react-icons/fa'
    ...
    <footer className='bg-gray-800 text-white py-8 px-4 md:px-16 lg:px-24'>
      <div className='container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8'>
        <div>
          ...
          <p className='mt-4'>your one step for all needs. Shop with us and experience the best online shopping experience.</p>
        </div>
